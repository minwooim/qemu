...
int nvme_ns_post_init(NvmeCtrl *n, NvmeNamespace *ns, Error **errp)
{
    ...
    if (!n->subsys->params.ana && ns->params.anagrpid) {
        error_setg(errp, "anagrpid needs 'ana=true' in nvme device");
        return -1;
    }
...
static Property nvme_ns_props[] = {
    ...
    DEFINE_PROP_UINT32("anagrpid", NvmeNamespace, params.anagrpid, 0),
